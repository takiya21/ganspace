...
class Config:
    ...
    def from_args(self, args=sys.argv[1:]):
        ...
        parser.add_argument('--model', dest='model', type=str, default='StyleGAN2', help='The network to analyze') # StyleGAN, DCGAN, ProGAN, BigGAN-XYZ PgGAN
        parser.add_argument('--layer', dest='layer', type=str, default='style', help='The layer to analyze, style or g_mapping')
        ...
        parser.add_argument('-m', type=int, default=100, help='Number of generation images')
        ...
        parser.add_argument('--out_dir', type=str, default='out', help='Path to save ipca whne using visualize')
